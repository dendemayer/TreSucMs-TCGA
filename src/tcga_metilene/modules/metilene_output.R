...
# some adjustments:
# awk '{print $1,'\t',$2,'\t'$3,'\t',$4,'\t',$5,'\t',$6, '\t',$9,'\t',$10}' met_output.txt > met_output_for_R.txt
...
#mean1 vs mean2
ggplot(data, aes(x=group1, y=group2)) + geom_point(alpha=.5) + coord_fixed() + xlab("mean alive") + ylab("mean dead") + theme_cfg
#nt vs CpGs
