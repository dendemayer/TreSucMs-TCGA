...
# # snakemake inputs:
# qval_out = "/scr/palinca/gabor/TCGA-pipeline_5/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/metilene/metilene_output/carboplatin_carboplatin,paclitaxel_cisplatin/female/cutoff_5/metilene_qval.0.05.out"
# metilene_input = "/scr/palinca/gabor/TCGA-pipeline_5/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/metilene/metilene_input_table/carboplatin_carboplatin,paclitaxel_cisplatin/female/cutoff_5/summary_for_metilene.tsv"
# script_file = "/homes/biertruck/gabor/phd/test_git_doc/tcga_piplines/src/tcga_metilene/scripts/bed_intersect_metilene.py"
# # snakemake output:
# out_file = "/scr/palinca/gabor/TCGA-pipeline_5/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/metilene/metilene_output/carboplatin_carboplatin,paclitaxel_cisplatin/female/cutoff_5/metilene_intersect.tsv"
# # snakemake wildcards:
...
try:
    ...
    DF_met_input = pd.read_table(metilene_input, na_values='-')
...
# the dropna(how='all') is only now usable, otherwise the index was not index
# and interpreted as values
...
# DONE single empty values are just set as dot from bedtools, turn them into
# nans, and on writing into '-' !
DF_met_inp_out.replace('.', pd.NA, inplace=True)
DF_met_inp_out.to_csv(out_file, sep='\t', na_rep=0)
