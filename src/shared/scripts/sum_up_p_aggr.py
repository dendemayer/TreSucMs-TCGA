...
if 'snakemake' in dir():
    ...
    # snakemake output:
    p_val_prod_sum = "/scr/palinca/gabor/TCGA-pipeline_10_pval_prod/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/metilene/metilene_output/carboplatin_carboplatin,paclitaxel_cisplatin/female_male/cutoff_0-cutoff_5-cutoff_8/threshold_0_threshold_5_threshold_10_threshold_20/metilene-beta_vals_p_prod_sum_.pdf"
    p_val_prod_sum_table = "/scr/palinca/gabor/TCGA-pipeline_10_pval_prod/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/metilene/metilene_output/carboplatin_carboplatin,paclitaxel_cisplatin/female_male/cutoff_0-cutoff_5-cutoff_8/threshold_0_threshold_5_threshold_10_threshold_20/metilene-beta_vals_p_prod_sum_.tsv.gz"
    # snakemake wildcards:
    ...
    # # snakemake output:
    # p_val_prod_sum = "/scr/palinca/gabor/TCGA-pipeline_10_pval_prod/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/DESeq2/DESeq2_output/carboplatin_carboplatin,paclitaxel_cisplatin/female_male/cutoff_0-cutoff_5-cutoff_8/threshold_0_threshold_5_threshold_10_threshold_20/DESeq2-norm_count_p_prod_sum_.pdf"
    # p_val_prod_sum_table = "/scr/palinca/gabor/TCGA-pipeline_10_pval_prod/TCGA-CESC_TCGA-HNSC_TCGA-LUSC/DESeq2/DESeq2_output/carboplatin_carboplatin,paclitaxel_cisplatin/female_male/cutoff_0-cutoff_5-cutoff_8/threshold_0_threshold_5_threshold_10_threshold_20/DESeq2-norm_count_p_prod_sum_.tsv.gz"
    # # snakemake wildcards:
    # output_path = "/scr/palinca/gabor/TCGA-pipeline_10_pval_prod"
    # pipeline = "DESeq2"
    # drug_combi = "carboplatin_carboplatin,paclitaxel_cisplatin"
...
DF_temp = DF.drop_duplicates('project + sex + cutoff').loc[:, ['project + sex + cutoff', 'nr_included_in_prod_sum', 'geometric_mean_nlog10', 'cutoff', 'project', 'sex']]
